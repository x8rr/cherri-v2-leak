...
import {
	...
	object_set,
	convert_body_inner,
	entries_of_object_inner,
	define_property,
	ws_key,
	ws_protocol,
	from_entries,
} from "data:application/javascript;base64,";
var wasm;
...
var EpoxyClientOptions = class {
	...
	free() {
		...
		const ret = wasm.__wbg_get_epoxyclientoptions_udp_extension_required(
			this.__wbg_ptr,
		);
		return ret !== 0;
	}
...
function __wbg_get_imports() {
	...
	imports.wbg.__wbg_newwithintounderlyingsink_3ea7ceafb3e69daf = function (
		arg0,
	) {
	...
	imports.wbg.__wbg_newwithintounderlyingsource_db318e6b93dffa9b = function (
		arg0,
		arg1,
	) {
...
var EpoxyTransport = class {
	...
	connect(
		...
		let handlers = new EpoxyHandlers(onopen, onclose, onerror, (data) =>
...
export { EpoxyTransport as default, info as epoxyInfo };
