    ...
    <div id="inner">
        ...
        <div id="info">
            <div id="errorTrace-wrapper">
                <textarea id="errorTrace" readonly placeholder="No error trace available."></textarea>
            ...
            <div id="troubleshooting">
                <div>
                    ...
                    <ul>
                        ...
                        <li>Verifying the address</li>
                        <li>Clearing site data</li>
                        <li>Contacting <b id="hostname"></b>'s owner</li>
                        <li>Verify Wisp server works</li>
                        <li>Changing Wisp settings</li>
                    </ul>
                </div>
                <div>
                    <span class="section-label">if you're the owner</span>
                    <ul>
                        <li>Restart the server</li>
                        <li>Update Scramjet</li>
                        <li>Check the <a href="https://github.com/MercuryWorkshop/scramjet" target="_blank">GitHub</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <p id="version-wrapper">
            <i>Scramjet v<span id="version"></span> (build <span id="build"></span>)</i>
        </p>
    </div>
